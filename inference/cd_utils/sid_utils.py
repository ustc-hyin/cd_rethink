...
def greedy_search(
    ...
    **model_kwargs,
    ...
    while True:
        ...
        use_cd = model_kwargs.get("use_sid") != None
        ...
        if use_cd:
            ## cd_comments: forward pass of the model
            model_inputs_cd = self.prepare_inputs_for_generation_sid(input_ids, **model_kwargs_cd)
            # print(model_inputs_cd)
            outputs_cd = self(
                **model_inputs_cd,
                return_dict=True,
